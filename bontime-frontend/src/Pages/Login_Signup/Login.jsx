          ...
          >
            ...
            >
              <Text textAlign={"left"} fontSize="14px">
                ...
                <b className={styles.boldte}>
                  Bill your clients automatically every quarter (US only){" "}
                </b>
                Working on quartely projects? You can now schedule your invoices
                to be sent automatically to...
              </Text>
            </HStack>
            <HStack p="0px 20px" alignItems={"flex-start"} my="10px">
              <Text textAlign={"left"} fontSize="14px">
                ...
                <b className={styles.boldte}>
                  Use Zapier to sync your other tools with Bonsai.
                </b>
                Using another tool to collect leads? You can now automatically
                send the info to Bonsai with...
              </Text>
            </HStack>
            <HStack p="0px 20px" alignItems={"flex-start"} my="10px">
              <Text textAlign={"left"} fontSize="14px">
                ...
                <b className={styles.boldte}>A brand new forms experience. </b>
                There's now a template library, a redesigned form builder, and
                new customization......
              </Text>
            </HStack>
            <HStack p="0px 20px" alignItems={"flex-start"} my="10px">
              <Text textAlign={"left"} fontSize="14px">
                ...
                <b className={styles.boldte}>
                  Allow clients to pay a deposit when signing a contract.{" "}
                </b>
                Two birds, one stone. When your client signs a contract they can
                also pay the requested deposit......
              </Text>
            </HStack>
            <HStack p="0px 20px" alignItems={"flex-start"} my="10px">
              <Text textAlign={"left"} fontSize="14px">
                ...
                <b className={styles.boldte}>
                  The new forms template library..{" "}
                </b>
                Need to create a client form? Get inspired and put one together
                in seconds with our new......
              </Text>
            </HStack>
