        ...
        >
          ...
          <Box h="auto" p="1em 1em">
            <Box id="formatProposal">
              <Text className="Hfsize">What is the format of a proposal?</Text>
              <p id="para">
            ...
            <Box id="includeBProposal">
              ...
              <p id="para">Here’s what you need to include:</p>
              ...
              <Text className="subH">About us & company overview</Text>
              <p id="para">
              ...
              <Text className="subH">Team members</Text>
              <p id="para">
              ...
              <Text className="subH">Portfolio of work</Text>
              <p id="para">
              ...
              <Text className="subH">Project schedule</Text>
              <p id="para">
              ...
              <Text className="subH">Deliverables</Text>
              <p id="para">
              ...
              <Text className="subH">Next steps</Text>
              <p id="para">
            ...
            <Box id="writeBProposal">
              ...
              <li className="liP">SaaS sales proposal template</li>
              <li className="liP">Video production proposal template</li>
              <li className="liP">Sponsorship proposal template</li>
              <li className="liP">Web design proposal template</li>
              <li className="liP">Writing proposals</li>
              <li className="liP">SEO proposal template</li>
              <p id="para">
              ...
              <Text className="subH">Use visual aids</Text>
              <p id="para">
              ...
              <Text className="subH">Pitch with personality</Text>
              <p id="para">
            ...
            <Box id="BProposalfaq">
              <Text className="Hfsize">Business Proposal template FAQs</Text>
              <p id="para">
              ...
              <Text className="subH">How do you write business proposals?</Text>
              <p id="para">
              ...
              <Text className="subH">What’s the format of a proposal?</Text>
              <p id="para">
