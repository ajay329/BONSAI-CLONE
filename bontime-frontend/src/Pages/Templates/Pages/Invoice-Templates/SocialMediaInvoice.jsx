        ...
        >
          ...
          <Box h="auto"  p="1em 1em">
            ...
            <Box id="createSMITB">
              ...
              <Text className={style.subH}>Bonsai saves you time</Text>
              <p id={style.para}>
              ...
              <p id={style.para}>Templates include all the relevant information</p>
              <p id={style.para}>
            ...
            <Box id="SMITfaq">
              ...
              <Text className={style.subH}>Are all the Bonsai templates free?</Text>
              <p id={style.para}>
