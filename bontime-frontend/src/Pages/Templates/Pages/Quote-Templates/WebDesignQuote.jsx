      ...
      <Box fontFamily="Proximanova opt sans-serif" mb="5rem">
        ...
        >
          ...
          <Box h="auto"  p="1em 1em">
            ...
            <Box id="WDQ">
              <Text className="Hfsize"> What is a Web Design Quotation?</Text>
              <p id="para">
            ...
            <Box id="includeWDQ">
              ...
              <Text className="subH">Cover page</Text>
              <p id="para">
              ...
              <Text className="subH">Executive summary</Text>
              <p id="para">
              ...
              <Text className="subH">Project description</Text>
              <p id="para">
              ...
              <Text className="subH">Here’s what to add:</Text>
              <li className="liP">
              ...
              <Text className="subH">Project milestones</Text>
              <p id="para">
              ...
              <li className="liP">Site launch: for publishing the website</li>
              <li className="liP">
              ...
              <Text className="subH">Project fees</Text>
              <p id="para">
              ...
              <Text className="subH">Company details</Text>
              <p id="para">
            ...
            <Box id="writeWDQ">
              ...
              <li className="liP">Web engineering</li>
              <li className="liP">Network security</li>
              <li className="liP">Website design</li>
              <li className="liP">Domain name registration</li>
              <li className="liP">Client-side or service scripting</li>
              <p id="para">
            ...
            <Box id="WDQB">
              ...
              <li className="liP">Find a website design quotation template</li>
              <li className="liP">
            ...
            <Box id="WDQfaq">
              <Text className="Hfsize">Web Design Quotation Template FAQs</Text>
              <Text className="subH">What is a web design quotation?</Text>
              <p id="para">
              ...
              <Text className="subH">How do web designers create a quote?</Text>
              <p id="para">Add these sections to create a web design quotation:</p>
              <li className="liP">Cover page</li>
              <li className="liP">Executive summary</li>
              <li className="liP">Project description</li>
              <li className="liP">Project deliverables</li>
              <li className="liP">Project milestones</li>
              <li className="liP">Project fees</li>
              <li className="liP">Company details</li>
