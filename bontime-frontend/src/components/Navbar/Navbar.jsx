        ...
        <Box className={style.bonProduct_leftContent}>
          <Box className={style.bonProduct}>
            <Box className={style.bonProduct_wrapper}>
              <Box className={style.bonProduct_title}>Bontime Workflow</Box>
              <p color="#4d4d4d">
          ...
          <Box className={style.bonProduct}>
            <Box className={style.bonProduct_wrapper}>
              ...
              <p color="#4d4d4d">
                Track expenses , maximize taxs writeoffs and estimate taxes
          ...
          <Box className={style.bonProduct}>
            <Box className={style.bonProduct_wrapper}>
              ...
              <p color="#4d4d4d">
                Bontime's is all-in-one financial hub: no fees lightning fast
                payouts
              </p>
            </Box>
          </Box>
          ...
          <Box opacity=".97" className={style.left_content}>
            <Box className={style.left_item}>
              ...
              >
                ...
                />
                <Box
                  className={style.left_item_title}
                  onClick={handleFreeContract}
                >
                  Contract Templates
                </Box>
              </Flex>
            ...
            <Box className={style.left_item}>
              ...
              >
                <Image
                  ...
                  height="20px"
                />
                <Box className={style.left_item_title} onClick={handleProposal}>
                  Proposal Templates
                </Box>
              </Flex>
            </Box>
            ...
            <Box className={style.left_item}>
              ...
              >
                <Image
                  ...
                  height="20px"
                />
                <Box className={style.left_item_title} onClick={handleInvoice}>
                  Invoice Templates
                </Box>
              </Flex>
            </Box>
            ...
            <Box className={style.left_item}>
              ...
              >
                <Image
                  ...
                  height="20px"
                />
                <Box className={style.left_item_title} onClick={handleQuotes}>
                  Quotes Templates
                </Box>
              </Flex>
            </Box>
            ...
            <Box className={style.left_item}>
              ...
              >
                <Image
                  ...
                  height="20px"
                />
                <Box className={style.left_item_title} onClick={handleScope}>
            ...
            <Box className={style.left_item}>
              ...
              >
                <Image
                  ...
                  height="20px"
                />
                <Box className={style.left_item_title} onClick={handleBrief}>
                  Brief Template
                </Box>
              </Flex>
            </Box>
